...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var client, info, data, sheets, _i, sheets_1, sheet, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    console.log("URL: ".concat(info.url));
                    console.log("Sheets: ".concat(info.sheets.map(function (s) { return s.title; }).join(', ')));
                    // 2. Get sample data
                    console.log('\n--- Sample Data ---');
                    return [4 /*yield*/, client.getWorksheetData('Sheet1!A1:C10')];
                case 3:
                    data = _a.sent();
                    console.log(JSON.stringify(data, null, 2));
                    // 3. Update a cell
                    console.log('\n--- Update Cell ---');
                    return [4 /*yield*/, client.updateCell('Sheet1!A1', 'Updated via TypeScript')];
                case 4:
                    _a.sent();
                ...
                case 5:
                    ...
                    for (_i = 0, sheets_1 = sheets; _i < sheets_1.length; _i++) {
                        sheet = sheets_1[_i];
                        console.log("- ".concat(sheet.title));
                    }
                    return [3 /*break*/, 7];
                case 6:
                    error_1 = _a.sent();
