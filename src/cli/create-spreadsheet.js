...
function createSpreadsheet(title) {
    return __awaiter(this, void 0, void 0, function () {
        var client, sheets, response, spreadsheet;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sheets.spreadsheets.create({
                            requestBody: {
                                properties: {
                                    title: title,
                                },
                ...
                case 1:
                    ...
                    console.log("  Title: ".concat((_a = spreadsheet.properties) === null || _a === void 0 ? void 0 : _a.title));
                    console.log("  ID: ".concat(spreadsheet.spreadsheetId));
                    console.log("  URL: ".concat(spreadsheet.spreadsheetUrl));
